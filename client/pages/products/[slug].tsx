			...
			{/* <div className={styles.singleProduct}>
				<div className={styles.singleProductContent}>
					<ImageSlider
						...
						images={productAttributes?.images?.data}
					/>
					...
					<div className={styles.right}>
						...
						{productAttributes?.Variations && (
							<Variations variations={productAttributes?.Variations} />
						)}
						<AddToCartButton />
					</div>
				</div>
...
export async function getServerSideProps({ req, params }: any) {
	...
	// populate strapi v4 component

	const productResponse = await fetcher(
		`${process.env.NEXT_PUBLIC_STRAPI_URL}/products/?filters\[Slug\][$eq]=${slug}&populate=deep`,
		jwt
			? {
					headers: {
